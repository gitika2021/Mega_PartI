...
python ../clean_codes_v2/run_inference_pipeline.py --config-file train_${ratio1}_${ratio2}.json --test 1 --N 99 --Num 130 --fresh_run 1 > ${base_dir}/N99_infer_${PBS_JOBID}.log 2>&1 && \
