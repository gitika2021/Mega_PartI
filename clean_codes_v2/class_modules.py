...
class MLPreProcessing():
    def __init__(self,Num=1000,N=1,maps_path=None, rsrp1=5, rsrp2=10,nproc=4,train_frac=0.8,seed=None,maps_folder_str="10", test=None,fresh_run=False,snr_min=1e6,snr_max=1e6,noise='gaussian', ldc_dist=None):
        self.Num = Num
        self.N = N
        self.nproc = nproc
        ...
        self.noise = noise
        self.ldc_dist = ldc_dist

        print("self.snr_min,self.snr_max,self.noise,self.ldc_dist",self.snr_min,self.snr_max, self.noise,self.ldc_dist)
